CREATE TABLE `payments` (
	...
	`phoneNumber` text,
	`metadata` text,
	`createdAt` integer DEFAULT '"2025-08-16T17:36:03.684Z"',
	`updatedAt` integer DEFAULT '"2025-08-16T17:36:03.684Z"',
...
CREATE TABLE `__new_cartItems` (
	...
	`addedAt` integer DEFAULT '"2025-08-16T17:36:03.684Z"',
...
CREATE TABLE `__new_users` (
	...
	`createdAt` integer DEFAULT '"2025-08-16T17:36:03.683Z"',
	`updatedAt` integer DEFAULT '"2025-08-16T17:36:03.683Z"'
);
--> statement-breakpoint
